...
export class SortOptions {
     ...
     */
    static direction: { ASC: string, DESC: string } = { ASC: 'ASC', DESC: 'DESC' };
}
...
export class ArraySortPipe implements PipeTransform {
    ...
    transform(array: Array<{}>, args: string[]): Array<string> | Array<{}> {
        ...
        // need to re-evaluate below code if we want to use sorting in dual-list-box items
        return _.orderBy(array, (item: {} | string) => item.hasOwnProperty(key) ? item[key] : item, direction['ASC'].toLowerCase());
    }
}
