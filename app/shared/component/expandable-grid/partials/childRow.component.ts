...
export class ChildRowRenderer implements ICellRendererAngularComp {
    public params: any;
    private listData = [];
    agInit(params: any): void {
        this.params = params;
        console.log(this.params.cellfieldId)
    ...
    OnChange(event)
    {
        this.params.context.componentParent.onChange(this.params.node.rowIndex, this.params.cellfieldId,  event.target.value,this.params.textfield, event.target.options[event.target.options.selectedIndex].text);
    }
}