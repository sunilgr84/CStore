...
export class BankLogoButtonComponent implements ICellRendererAngularComp {
    isEdit: boolean;
    imgURL: any | '';
    ...
    agInit(params: any): void {
        this.params = params;
        if (this.params.data.bankLogo) {
            this.imgURL = this.params.data.bankLogo;
        }
    }
   /*  public deleteImage() {
        this.imgURL = '';
