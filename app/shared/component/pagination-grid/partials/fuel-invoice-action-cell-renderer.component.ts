...
export class FuelInvoiceActionsCellRenderer implements ICellRendererAngularComp {
    ...
    agInit(params: any): void {
        this.params = params;
        if (params.data && (params.data.fuelInvoiceFileName === "" || params.data.fuelInvoiceFileName === null)) {
