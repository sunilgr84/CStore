...
@Component({
    ...
    template: `<input type="text"  #input numeric [decimals]="6"  class="ag-cell-edit-input"
...
export class SixDecimalNumericEditor implements ICellEditorAngularComp, AfterViewInit {
    private params: any;
    public value: number;
