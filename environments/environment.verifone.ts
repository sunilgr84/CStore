export const environment = {
  production: true,
  baseUrl: 'https://6measj7ik4.execute-api.us-east-1.amazonaws.com/api/',
  ...
  // accountUrl: 'http://69.60.116.16:5002/api/', // Account service - Payment
  // fuelService: 'http://69.60.116.16:5003/api/', // fuelService service - Payment
  // itemService: 'http://69.60.116.16:5004/api/', // Items Service
  // authService: 'http://69.60.116.16:5011/api/', // Auth Service
